...
class FaceDetector:
    ...
    def prepare(self, use_gpu, nms=0.4, fix_image_size=None, ctx=0):
        ...
        if use_gpu:
            self.ort_session = onnxruntime.InferenceSession(self.onnx_file, providers=providers)
            ...
            self.ort_session = onnxruntime.InferenceSession(self.onnx_file, sess_options=sessionOptions, providers=providers)
